 	    ...
 	    ( function() {
            ...
            var $content = $this.children(".jbgContentDiv");
	 	    ...
	 	    if( $.browser.msie )
	 	    {
	 	    	...
	 	    	switch(borderTop)
	 	    	{
		 	    	case "thin": 	borderTop="2px";
		 	    	case "medium":	borderTop="4px"; 
		 	    	case "thick":	borderTop="6px";  
	 	    	}
	 	    	switch(borderLeft )
	 	    	{
		 	    	case "thin": 	borderLeft ="2px";
		 	    	case "medium":	borderLeft ="4px"; 
		 	    	case "thick":	borderLeft ="6px";  
	 	    	}
            ...
            else
            {
    	 	    ...
    	 	    + ' top:-'+borderTop+'; left:-'+borderLeft+'; width:0px; height:0px;  z-index:0;">' 
